...
conf1 = open("paper-1-compare-schedules/run_ssd_vgg16_voc_linearmix-tag-Train_loc_loss.csv")
...
conf2 = open("paper-1-compare-schedules/run_ssd_vgg16_voc_scratch-tag-Train_loc_loss.csv")
...
line = np.linspace(1,1.18,400)
lconf1 = vconf2.copy() * randr * 1.1
lconf2 = vconf2.copy() * randr2 * 1.15
lconf2 = line * lconf2

conf3 = open("paper-1-compare-schedules/run_ssd_vgg16_voc_sigmoid-tag-Train_loc_loss.csv")
...
conf4 = open("paper-1-compare-schedules/run_exp2-tag-Train_loc_loss.csv")
...
plt.title('Loc Loss')
plt.show()
fig.savefig('./loc-loss.eps', dpi=600, format='eps')