...
def load_data():
  ...
  ys = []
  for i in range(1, 6):
    filename = '/media/trans/mnt/code_test/my_projects/mixup-master/cifar/data/cifar-10-batches-py/data_batch_' + str(i)
  ...
  x_test, y_test = load_CIFAR10_batch('/media/trans/mnt/code_test/my_projects/mixup-master/cifar/data/cifar-10-batches-py/test_batch')
